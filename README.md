...
Асинхронный парсер документации Python Enhancement Proposals (PEP), разработанный на Scrapy.

Проект собирает информацию о PEP-документах, анализирует их статусы и формирует статистические отчеты в CSV формате.
## Особенности проекта
